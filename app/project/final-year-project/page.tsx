    ...
    <section className="2xl:text-3xl mx-2 w-full flex flex-col justify-center items-center lg:text-xl">
      ...
      <div className="flex w-full justify-between items-center">
        <Card className="w-fit h-fit" heading ={
          <h2 className="text-2xl 2xl:text-5xl"> Glaucoma detection using clustering algorithms - Capstone Project </h2>
          
        }/>
        <SmallLinks visit="https://glaucoma-detector.vercel.app/" git="https://github.com/Joshuajrodrigues/glaucoma-detector" />
