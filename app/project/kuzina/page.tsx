...
const page = () => {
  return (
    <section className="mx-2 w-full flex flex-col justify-center items-center lg:text-xl 2xl:text-3xl">
      ...
      <div className="flex w-full justify-between items-center">
        <Card className="w-fit h-fit" heading ={
          <h2 className="text-2xl 2xl:text-5xl">Kuzina - Kitchen Mangement </h2>
          
        }/>
       
       
        <SmallLinks visit="https://kuzina.vercel.app/" git="https://github.com/Joshuajrodrigues/kuzina"/>
      </div>
